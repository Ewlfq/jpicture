...
a.css(d);var c=d.height;h.lastPicture.width=e;h.lastPicture.height=c};f.src=b};g.ajax({url:l.location.href,cache:!0,processData:!1}).always(function(){if("IMG"===b.tagName){var c=g(b);c.attr("src",a.key);c.css("display","block");var d=g(c).width(),c=g(c).height();h.lastPicture.width=d;h.lastPicture.height=c}else e(g(b),a.key);h.callback&&h.callback(b)})},s=function(b,a){g(l).resize(function(){k(b,a)})},t=function(b,a){switch(l.orientation){case -90:case 90:k(b,a);break;default:k(b,a)}},k=function(b,
