    ...
    return this.each(function () {
        ...
        fetchImg =  function (container, imgProp, containerWidth) {  
            ...
            $.ajax({
                ...
                // TODO: Store last picture url, so we do not have to reload the same picture while resizing
        ...
        onOrientationChange = function (container, picList) {
            switch (win.orientation) {  
                case -90: case 90: main(container, picList); break; 
                default: main(container, picList); break; 
            }
        },
        ...
        main = function (container, picList) {
            ...
            // TODO: only fetch if a new pic needed
            if (true) {
